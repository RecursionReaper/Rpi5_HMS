        ...
        <div className="flex flex-col min-h-screen overflow-hidden">
          ...
          <nav className="sticky top-0 z-50 border-b border-zinc-800 backdrop-blur-xl bg-zinc-950/80">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between h-16 items-center">
                ...
                >
                  <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-purple-600 to-blue-500 flex items-center justify-center shadow-lg shadow-purple-500/20">
          ...
          <main className="flex-1 relative z-10 mt-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
              <div className="bg-zinc-900/30 backdrop-blur-2xl border border-zinc-800/50 rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 hover:border-zinc-700/70">
                {children}
              </div>
            </div>
          </main>
